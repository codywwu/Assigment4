...
public class ModelTest {
  ...
  public void testCheckFileExists() {
    ...
    //        Assert.assertTrue("Should return true for existing files",
    // model.checkFileExists(existingFileName));
    Assert.assertFalse(
        "Should return false for non-existing files", model.checkFileExists(nonExistingFileName));
  }
